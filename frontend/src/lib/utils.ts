...
const quotes: Quote[] = [
    {
        phrase: "The beautiful thing about learning is that nobody can take it away from you.",
        author: "B.B. King",
    },
    {
        phrase: "Success is not the key to happiness. Happiness is the key to success.",
    ...
    {
        phrase: "Do not wait for leaders; do it alone, person to person.",
