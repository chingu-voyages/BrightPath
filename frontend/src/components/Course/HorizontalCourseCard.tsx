        ...
        <div className='p-4'>
            <div>
              ...
              <div className='w-full flex flex-col lg:flex-row justify-between gap-4 lg:items-center'>
                  ...
                  {
                      completed ? (
                          <Link className='max-w-fit lg:w-full p-6 text-center rounded-md font-semibold text-lg text-slate-100 dark:text-slate-800 bg-slate-700 dark:bg-slate-400' href={'/cerificate/??'}>
                              View certificate
                          </Link>
                      ):<Link className='flex gap-2 p-2 px-4 rounded-md min-w-fit w-1/3 lg:w-1/3 text-slate-100 dark:text-slate-800  bg-slate-700 dark:bg-slate-400' href={`/course/${course.id}`}>
                            <div>
                                <p className='text-sm italic font-thin'>Continue learning:</p>
                                
                                <div className='text-lg font-semibold flex justify-center items-center gap-2'>
                                    {/* <p>
                                        
                                    </p> */}
                                    <DesktopOutlined style={{fontSize:24,padding:0}} />
                                    {/* ??last chap */}
