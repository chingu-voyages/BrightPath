...
type SignInError = "Signin" | "OAuthSignin" | "OAuthCallbackError" | "OAuthCreateAccount" | "EmailCreateAccount" | "Callback" | "OAuthAccountNotLinked" | "EmailSignin" | "CredentialsSignin" | "SessionRequired"
...
export default async function SignInPage(props: {
    searchParams: { callbackUrl: string | undefined, error: SignInError | undefined }
}) {
    ...
    return (
        <div className="max-w-sm mx-auto mt-24">
            <div className="flex flex-col gap-y-2 text-center mb-4">
                <Image src="/Logo_Icon.png" width={42} height={56} alt="BrightPath logo" className="mx-auto" />
            ...
            <div className="border p-5 flex flex-col gap-2 mb-6">
                {Object.values(providerMap).map((provider) => (
                    ...
                    >
                        <button type="submit" className="button-primary flex items-center justify-between">
                ...
                >
                    ...
                    <input name="email" id="email" type="email" placeholder="joe@example.com" />
            ...
            {error && (
                ...
                >
                    <div className="font-normal text-gray-700 dark:text-gray-400">
                        {signinErrors[error] || "Please contact us if this error persists."}
                    </div>
                </a>
            )}
        </div>
