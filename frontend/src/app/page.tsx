    ...
    return (
        <>
            ...
            < section className="grid md:grid-cols-2 gap-8 bg-gray-100 p-6 rounded-lg" >
                <div>
                    <h1 className="text-4xl font-bold mb-4">Welcome to BrightPath!</h1>
                    <p className="text-gray-700 mb-4">
                        Ready to take your dev journey deeper? Learn by doing, with hands-on
                        project-based exercises, and stand out from the crowd with specialized
                        knowledge and skills.
                    </p>
                    <p className="text-gray-700">
                        The <strong>BrightPath</strong> platform and courses were created by a
                        multidisciplinary team of software development professionals in order to
                        give back to our community as we learn in public.
                    </p>
                </div>
                <div className="flex justify-center items-center">
                    <img src="/hero-placeholder.png" alt="Hero" className="rounded-lg" />
                </div>
            </section >
            ...
            < section className="mt-12" >
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    {["Zuaida really kept our team on track.", "Joseph does a great job demonstrating tech tools.", "BrightPath is a great place to grow as a developer."].map((testimonial, idx) => (
                        <div key={idx} className="border p-6 rounded-lg shadow-md bg-white text-gray-700">
                            {testimonial}
                        </div>
                    ))}
                </div>
            ...
            < section className="mt-12 bg-gray-100 p-6 rounded-lg" >
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    <div className="border p-6 rounded-lg bg-white text-center">
                        ...
                        <p className="text-lg font-bold mt-2">Bring Your App to Life with Tailwind Motion</p>
                    </div>
                    <div className="p-6">
